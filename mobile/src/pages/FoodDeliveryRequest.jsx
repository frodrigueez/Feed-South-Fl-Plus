...
const FoodDeliveryRequest = () => {
  const { actions: scheduleDelivery } = useContext(Context);
    ...
    <>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="col-6 p-0 pr-2">
                {" "}
                <button
                  className={`${style.button} p-2 btn btn-block text-left pl-4 text-white`}
                >
                  Yes
                </button>{" "}
              </div>
              <div className="col-6 p-0 pl-2">
                {" "}
                <button
                  className={`${style.buttonNo} p-2 btn btn-block text-left pl-4 text-dark`}
                >
                  No
                </button>{" "}
              </div>
      ...
      <div className={`${style.secondary} pt-4`}>
        ...
        <div
          ...
          style={{ color: "#D6D6D6", fontWeight: "700", fontSize: "1.25em" }}
        >
            ...
            <div className="row">
              <div className={`col-10 mx-auto`}>
                <Link to="/seeker/route">
                  <button
                    className={`${style.button} btn btn-block p-3 text-white`}
